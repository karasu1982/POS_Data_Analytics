...
|  | RFM分析 |  |  |
|  | クラスタリング・セグメンテーション |  |  |
| 商品観点 | ABC分析 |商品別の売り上げを比較し、売り上げ上位からA, B, Cの3つのグループに分ける。品揃えや商品の入れ替え・在庫管理などに利用される | https://github.com/karasu1982/POS_Data_Analytics/blob/main/ABC%E5%88%86%E6%9E%90.ipynb |
|  | リピート率 |  |  |
|  | バスケット分析 |  |  |
|  | 購買順分析 |  |  |
